...
ALTER TABLE `doc_all` ADD FOREIGN KEY (`theme_code`) REFERENCES `themes` (`code`);

ALTER TABLE `doc_all` ADD FOREIGN KEY (`event_name`) REFERENCES `events` (`name`);
...
INSERT INTO themes(code, name, info) VALUES
('t100', 'Economie', ''),
('t1000', 'Mobiliteit', ''),
('t1200', 'Justitie', ''),
('t1300', 'Sociale zaken', ''),
...
('t1600', 'Defensie', ''),
('t1700', 'Wetenschap', ''),
('t1800', 'Buitenlandse handel', ''),
('t1900', 'Buitenlandse zaken', ''),
('t200', 'Burgerrechten', ''),
('t2000', 'Functioneren democratie', ''),
('t2100', 'Ruimtelijke ordening', ''),
('t2300', 'Cultuur', ''),
('t24', 'Gemeen en prov bestuur', ''),
('t27', 'Weer en natuurrampen', ''),
('t28', 'Branden en ongelukken', ''),
('t29', 'Sport', ''),
('t30', 'Overlijdensberichten', ''),
('t300', 'Gezondheid', ''),
('t31', 'Kerken en religie', ''),
('t400', 'Landbouw', ''),
('t500', 'Arbeid', ''),
('t600', 'Onderwijs', ''),
('t700', 'Milieu', ''),
